...
public final class SpawnActionData extends Table {
  ...
  public ru.nsu.fit.dib.projectdib.flatbuffersclasses.update.NewEntityData data() { return data(new ru.nsu.fit.dib.projectdib.flatbuffersclasses.update.NewEntityData()); }
  public ru.nsu.fit.dib.projectdib.flatbuffersclasses.update.NewEntityData data(ru.nsu.fit.dib.projectdib.flatbuffersclasses.update.NewEntityData obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
